...
c_1->cd();
h1=new TH1F("h1","All Gammas",100,0.08,0.18);
ntp.Project("h1","2g.0");
h1->SetXTitle("Mass[`2g#]                                     ");
h1->SetYTitle("Events/1MeV");
h1->Fit("gaus");
//gStyle.SetOptFit(11);
h1->Draw();

c_2->cd();
h2=new TH1F("h2"," 1 BCAL and 1 LGD Gamma ",100,0.08,0.18);
ntp.Project("h2","2g.0","Nlgd==1&&Nbcal==1");
h2->SetXTitle("Mass[`2g#]                                     ");
h2->SetYTitle("Events/1MeV");
h2->Fit("gaus");
h2->Draw();


c_3->cd();
h3=new TH1F("h3"," LGD Gammas ",100,0.08,0.18);
...
c_4->cd();
h4=new TH1F("h4"," BCAL Gammas ",100,0.08,0.18);
