...
int main(int argC, char* argV[])
{
   ...
   "   }\n"
   "   else if (m_xraw != 0 && m_bytes_read == 0) {\n"
   "      m_istr.rdbuf(m_xraw);\n"
   "      delete m_xcmp;\n"
   "      m_xcmp = 0;\n"
   "      m_xraw = 0;\n"
   ...
   "      throw std::runtime_error(\"hddm_" + classPrefix +
   "::istream::configure_streambufs error\"\n"
   "               \" - cannot reconfigure compression in mid-stream!\");\n"
   "   }\n"
   "}\n"
   "\n"
   ...
   " requested.\");\n"
   "   }\n"
   "   else if (m_xraw != 0 && m_bytes_written == 0) {\n"
   "      m_ostr.rdbuf(m_xraw);\n"
   "      delete m_xcmp;\n"
   "      m_xcmp = 0;\n"
   "      m_xraw = 0;\n"
   ...
   "   else if (m_xraw != 0) {\n"
   "      throw std::runtime_error(\"hddm_" + classPrefix +
   "::ostream::configure_streambufs"
   " error\"\n"
   "                          \" - cannot reconfigure compression"
   " in mid-stream!\");\n"
   "   }\n"
   "}\n"
   "\n"
...
void CodeBuilder::constructIOstreams(DOMElement* el)
{
   ...
   "   }\n"
   "   m_ostr << m_sstr.str();\n"
   "   m_bytes_written += m_sstr.str().size();\n"
   "   m_records_written++;\n"
   "   if (!m_ostr.good()) {\n"
   "      throw std::runtime_error(\"hddm_" + classPrefix +
